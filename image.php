...
/*
	...
	TODO Documentation, Proper Error Handling, Add override for dimensions larger than source (currently it forces the scale)
*/
...
class Image
{
	...
	public function scale($new_width = null, $new_height = null)
	{
		...
		return $this->resize($new_width, $new_height, 0, 0, $new_width, $new_height);
	}
